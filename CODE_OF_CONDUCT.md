...
**confidentially through GitHub Private Vulnerability Reporting** on this repository (the **Security**
tab → **Report a vulnerability**, or
<https://github.com/cendorhq/cendor-sdk/security/advisories/new>), which opens a private report only
